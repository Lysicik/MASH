...
ax.scatter(x=data['duration_ms'], y=data['artist'])
...
f, ax = plt.subplots()
sns.violinplot(x=data['duration_ms'])
st.pyplot(f)

st.subheader('Масштабирование данных')
f, ax = plt.subplots()
plt.hist(data['duration_ms'], 50)
plt.show()
st.pyplot(f)
...
ax = plt.scatter(X_test['loudness_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['loudness_scaled'], Y_predict, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('loudness_scaled')
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['loudness_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['loudness_scaled'], Y_predict3, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('loudness_scaled')
plt.ylabel('rating_bad')
plt.plot(n_estimators_1)
...
ax = plt.scatter(X_test['loudness_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['loudness_scaled'], Y_grad_pred, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('loudness_scaled')
plt.ylabel('rating_bad')
...
grad1 = GradientBoostingRegressor(n_estimators=25, max_features=1, min_samples_leaf=0.01, random_state=10)
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['loudness_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['loudness_scaled'], Y_grad_pred1, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('loudness_scaled')
plt.ylabel('rating_bad')
plt.plot(n_estimators_1)
...
plt.scatter(X_test['loudness_scaled'], Y_test, marker='s', label='Тестовая выборка')
plt.scatter(X_test['loudness_scaled'], lr_y_pred, marker='o', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('loudness_scaled')
plt.ylabel('rating_bad')
plt.show()
